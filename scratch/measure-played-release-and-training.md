...
| Can the frozen PR #153 verifier remain a prerequisite after main advances? | No. After the publish rebase changed shared Command/search providers, PR #153 correctly reported its checked receipt source closure as stale even though its immutable receipt was unchanged. | Pin and validate that receipt as provenance without regenerating it. RUL-9 independently re-executes and retains all 132 current live/headless/persisted-replay Commands, witnesses, ordered events, and cross-surface trace hashes. |
