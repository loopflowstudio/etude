# Milestone 1: the two-deck slice — stage results

Migrated 2026-07-10 from `wave/rules/01-two-deck-slice.md` (plans stay in
wave docs; finished results live here). Spec/context in that doc.
