...
>
  <div class="flex h-full items-center justify-center rounded-md border border-slate-500/60 bg-slate-900/70 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-300">
    Hidden
  </div>
</div>
