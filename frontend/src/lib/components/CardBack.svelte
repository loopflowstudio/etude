...
>
  <div class="flex h-full items-center justify-center rounded-md border border-purple-500/40 bg-purple-900/15 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-300">
    Hidden
  </div>
</div>
